...
PieKBS admite la versión del protocolo MCP `2025-06-18`. Al conectarse vía HTTP, los clientes pueden incluir opcionalmente el encabezado `MCP-Protocol-Version` para garantizar la compatibilidad.
